        ...
        <div class="card-body">
            ...
            @forelse($recentRentals as $r)
                <div style="display:flex; align-items:center; gap:10px; padding:9px 0; border-bottom:1px solid var(--border);">
                    <span style="font-size:22px;">{{ $r->movie->poster_emoji }}</span>
                    <div style="flex:1;">
    ...
    <table class="data-table">
        ...
        <tbody>
            @forelse($activeRentals as $r)
                <tr>
                    <td><div style="display:flex; align-items:center; gap:8px;"><span style="font-size:18px;">{{ $r->movie->poster_emoji }}</span>{{ $r->movie->title }}</div></td>
