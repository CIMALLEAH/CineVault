...
<div style="max-width:680px;">
    <div class="card">
        <div class="card-body">
            <form method="POST" action="{{ route('staff.rentals.store') }}" id="rental-form">
                @csrf
                ...
                <div style="display:grid; grid-template-columns:1fr 1fr; gap:14px;">
                    ...
                    <div class="form-group" id="ref-group" style="display:none;">
                        ...
                        <input class="form-input" type="text" name="payment_reference" value="{{ old('payment_reference') }}" placeholder="GCash ref / last 4 digits">
                    </div>
                </div>
                ...
                <div style="padding:14px; background:rgba(200,160,74,.07); border:1px solid rgba(200,160,74,.18); border-radius:6px; margin-bottom:16px;">
                    <div style="display:flex; justify-content:space-between; font-size:13px; margin-bottom:5px;">
                        <span style="color:var(--text2);">Rental type:</span><span id="type-display">Daily</span>
                    </div>
                    <div style="display:flex; justify-content:space-between; font-size:13px; margin-bottom:5px;">
                        <span style="color:var(--text2);">Duration:</span><span id="duration-display">—</span>
                    </div>
                    <div style="display:flex; justify-content:space-between; font-size:13px; margin-bottom:5px;">
                        <span style="color:var(--text2);">Rate:</span><span id="rate-display">—</span>
                    </div>
...
@section('scripts')
@include('partials.rental-type-script', ['routePrefix' => 'staff'])
@endsection